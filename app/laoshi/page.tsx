...
const REASONS = [
  ...
  },
  {
    ...
    title: '接单才付费，没开成课可退',
    desc: '注册、展示、看需求全程免费。只有您决定接这一单时，才付一次信息服务费；如果因为家长那边的原因没能开课，联系教务全额退回。',
  },
]
...
const FAQS = [
  ...
  {
    q: '接了单但家长后来不上了怎么办？',
    a: '因家长方原因没能开课（失联、临时取消、需求与描述不符），联系教务说明情况，核实后全额退回，当个工作日内处理。教务工作时段 10:00–18:00。这笔费用的状态在教师端能查到：刚付完是「待核销」，这一单真的开课了才转「已核销」，退了会显示「已退款」并带上教务的说明。',
  },
  {
    q: '一定要有教师资格证吗？',
